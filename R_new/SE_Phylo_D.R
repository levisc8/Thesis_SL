# This code is a very slightly modified form of the phylo.d() function
# from the caper packager. It uses standard quoting for evaluation which
# allows easier usage in iterative calculations. 

SE_phylo.d <- function (data, phy, names.col, binvar, permut = 1000, rnd.bias = NULL) 
{
  if (!missing(data)) {
